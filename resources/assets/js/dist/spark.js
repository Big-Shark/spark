...
},{"./lib/jsonp":7,"./lib/promise":8,"./lib/util":9,"./lib/xhr":10}],6:[function(require,module,exports){
/**
 * Install plugin.
 */
...
},{"./http":5,"./resource":11,"./url":12}],7:[function(require,module,exports){
/**
 * JSONP request.
 */
...
},{"./promise":8,"./util":9}],8:[function(require,module,exports){
/**
...
},{"./promise":8,"./util":9}],11:[function(require,module,exports){
/**
...
},{"./lib/util":9}],12:[function(require,module,exports){
/**
...
},{"./lib/util":9}],13:[function(require,module,exports){
var _ = require('../util')
...
},{"../compiler":23,"../util":74,"_process":85}],19:[function(require,module,exports){
(function (process){
var _ = require('./util')
var config = require('./config')
...
},{"./config":25,"./util":74,"_process":85}],20:[function(require,module,exports){
/**
...
},{"../config":25,"../directives/prop":41,"../parsers/path":64,"../parsers/text":66,"../util":74,"_process":85}],22:[function(require,module,exports){
(function (process){
var _ = require('../util')
...
},{"../config":25,"../directives/component":30,"../parsers/directive":62,"../parsers/template":65,"../parsers/text":66,"../util":74,"./compile-props":21,"_process":85}],23:[function(require,module,exports){
var _ = require('../util')
...
},{"../config":25,"../parsers/template":65,"../util":74,"_process":85}],25:[function(require,module,exports){
module.exports = {
...
},{"./config":25,"./parsers/expression":63,"./parsers/text":66,"./util":74,"./watcher":78}],27:[function(require,module,exports){
// xlink
...
},{"../config":25,"../parsers/template":65,"../util":74,"_process":85}],31:[function(require,module,exports){
module.exports = {
...
},{"../cache":20,"../compiler":23,"../parsers/template":65,"../transition":67,"../util":74,"_process":85}],34:[function(require,module,exports){
...
},{"../../util":74,"./checkbox":35,"./radio":37,"./select":38,"./text":39,"_process":85}],37:[function(require,module,exports){
var _ = require('../../util')
...
},{"../../parsers/directive":62,"../../util":74,"../../watcher":78,"_process":85}],39:[function(require,module,exports){
var _ = require('../../util')
...
},{"../util":74,"_process":85}],41:[function(require,module,exports){
...
},{"../util":74,"_process":85}],43:[function(require,module,exports){
(function (process){
var _ = require('../util')
var config = require('../config')
...
},{"../compiler":23,"../config":25,"../parsers/expression":63,"../parsers/template":65,"../parsers/text":66,"../util":74,"_process":85}],44:[function(require,module,exports){
var transition = require('../transition')
...
},{"../cache":20,"../compiler":23,"../directives/if":33,"../parsers/template":65,"../parsers/text":66,"../util":74,"_process":85}],51:[function(require,module,exports){
var _ = require('../util')
var Path = require('../parsers/path')
...
},{"../util":74,"_process":85}],55:[function(require,module,exports){
...
},{"../util":74,"_process":85}],57:[function(require,module,exports){
(function (process){
var _ = require('../util')
var compiler = require('../compiler')
...
},{"../compiler":23,"../observer":60,"../observer/dep":59,"../util":74,"../watcher":78,"_process":85}],58:[function(require,module,exports){
var _ = require('../util')
...
},{"../cache":20,"../util":74,"./path":64,"_process":85}],64:[function(require,module,exports){
(function (process){
var _ = require('../util')
var Cache = require('../cache')
...
},{"../cache":20,"../util":74,"_process":85}],65:[function(require,module,exports){
var _ = require('../util')
var Cache = require('../cache')
...
},{"./index":74,"_process":85}],71:[function(require,module,exports){
(function (process){
/**
...
},{"../config":25,"_process":85}],72:[function(require,module,exports){
(function (process){
var _ = require('./index')
var config = require('../config')
...
},{"../config":25,"./index":74,"_process":85}],73:[function(require,module,exports){
...
},{"../config":25,"./index":74,"_process":85}],77:[function(require,module,exports){
var _ = require('./util')
var extend = _.extend
...
},{"./batcher":19,"./config":25,"./observer/dep":59,"./parsers/expression":63,"./util":74,"_process":85}],79:[function(require,module,exports){
'use strict';
...
Vue.component('spark-simple-registration-screen', {
    ...
    methods: {
        ...
        register: function register(e) {
            ...
            this.$http.post('/register', this.registerForm).success(function (response) {
        ...
        register: function register(e) {
            ...
            */
            ...
            Stripe.card.createToken(payload, function (status, response) {
                if (response.error) {
                    _this2.cardForm.errors.push(response.error.message);
                    _this2.registerForm.registering = false;
                } else {
                    _this2.registerForm.stripe_token = response.id;
...
},{"./../auth/registration/simple":79,"./../auth/registration/subscription":80,"./../common/errors":81,"./../nav":84,"./../settings/dashboard":86,"./../settings/dashboard/subscription":87,"./../settings/dashboard/teams":88,"./../settings/team":89,"./../settings/team/membership":90}],83:[function(require,module,exports){
/*
...
},{"bootstrap-sass/assets/javascripts/bootstrap":1,"jquery":2,"moment":3,"underscore":4,"vue":77,"vue-resource":6}],84:[function(require,module,exports){
'use strict';
...
Vue.component('spark-settings-subscription-screen', {
     ...
     */
    watch: {
        'subscribeForm.plan': function subscribeFormPlan(value, oldValue) {
            if (value.length > 0) {
                setTimeout(function () {
                    $('.spark-first-field').filter(':visible:first').focus();
                }, 250);
    ...
    computed: {
        ...
        currentPlan: function currentPlan() {
            ...
            var plan = _.find(this.plans, function (plan) {
                return plan.id == _this.user.stripe_plan;
            });
        ...
        selectedPlan: function selectedPlan() {
            ...
            return _.find(this.plans, function (plan) {
                return plan.id == _this2.subscribeForm.plan;
            });
        },
        ...
        monthlyPlansExceptCurrent: function monthlyPlansExceptCurrent() {
            ...
            return _.filter(this.monthlyPlans, function (plan) {
                return plan.id != _this3.currentPlan.id;
            });
        },
        ...
        yearlyPlansExceptCurrent: function yearlyPlansExceptCurrent() {
            ...
            return _.filter(this.yearlyPlans, function (plan) {
                return plan.id != _this4.currentPlan.id;
            });
        },
    ...
    methods: {
        ...
        subscribe: function subscribe() {
            ...
            Stripe.card.createToken(payload, function (status, response) {
                if (response.error) {
                    _this5.subscribeForm.errors.push(response.error.message);
                    _this5.subscribeForm.subscribing = false;
                } else {
                    _this5.subscribeForm.stripe_token = response.id;
                    _this5.sendSubscription();
                }
            });
        },
        ...
        sendSubscription: function sendSubscription() {
            this.$http.post('settings/user/plan', this.subscribeForm).success(function (user) {
                this.user = user;
        ...
        changePlan: function changePlan() {
            ...
            this.$http.put('settings/user/plan', { plan: this.changePlanForm.plan }).success(function (user) {
                this.user = user;
        ...
        updateCard: function updateCard(e) {
            ...
            Stripe.card.createToken(payload, function (status, response) {
                if (response.error) {
                    _this6.updateCardForm.errors.push(response.error.message);
                    _this6.updateCardForm.updating = false;
                } else {
                    _this6.updateCardUsingToken(response.id);
                }
            });
        },
        ...
        updateCardUsingToken: function updateCardUsingToken(token) {
            this.$http.put('settings/user/card', { stripe_token: token }).success(function (user) {
                this.user = user;
        ...
        updateExtraBillingInfo: function updateExtraBillingInfo() {
            ...
            this.$http.put('settings/user/vat', this.extraBillingInfoForm).success(function () {
        ...
        cancelSubscription: function cancelSubscription() {
            ...
            this.$http['delete']('settings/user/plan').success(function (user) {
                var _this7 = this;
                ...
                setTimeout(function () {
                    _this7.cancelSubscriptionForm.cancelling = false;
                }, 500);
            }).error(function (errors) {
        ...
        resumeSubscription: function resumeSubscription() {
            ...
            this.$http.post('settings/user/plan/resume').success(function (user) {
                this.user = user;
...
Vue.component('spark-settings-teams-screen', {
    ...
    methods: {
        ...
        createTeam: function createTeam(e) {
            e.preventDefault();

            this.createTeamForm.errors = [];
            this.createTeamForm.creating = true;

            this.$http.post('/settings/teams', this.createTeamForm).success(function (teams) {
        ...
        leaveTeam: function leaveTeam(team) {
            ...
            this.$http['delete']('/settings/teams/' + team.id + '/membership').success(function (teams) {
                this.$dispatch('updateUser');
                this.$dispatch('teamsUpdated', teams);
            });
        },
        ...
        deleteTeam: function deleteTeam() {
            ...
            this.$http['delete']('/settings/teams/' + this.teamToDelete.id).success(function (teams) {
        ...
        acceptInvite: function acceptInvite(invite) {
            ...
            this.$http.post('/settings/teams/invitations/' + invite.id + '/accept').success(function (teams) {
                this.$dispatch('updateUser');
                this.$dispatch('teamsUpdated', teams);
            });
        },
...
Vue.component('spark-team-settings-screen', {
  ...
  */
   ...
   */
		teamUpdated: function teamUpdated(team) {
			this.team = team;
   ...
   */
		getTeam: function getTeam() {
			this.$http.get('/spark/api/teams/' + TEAM_ID).success(function (team) {
				this.team = team;
...
Vue.component('spark-team-settings-membership-screen', {
    ...
    computed: {
         ...
         */
        teamUsersExceptMe: function teamUsersExceptMe() {
            var _this = this;
    ...
    methods: {
        ...
        sendInvite: function sendInvite(e) {
            ...
            this.$http.post('/settings/teams/' + TEAM_ID + '/invitations', this.sendInviteForm).success(function (team) {
        ...
        cancelInvite: function cancelInvite(invite) {
            ...
            this.$http['delete']('/settings/teams/' + TEAM_ID + '/invitations/' + invite.id).success(function (team) {
                this.$dispatch('teamUpdated', team);
            });
        },
         ...
         */
        editTeamMember: function editTeamMember(teamUser) {
            //
        },
         ...
         */
        removeTeamMember: function removeTeamMember(teamUser) {
            this.team.users = _.reject(this.team.users, function (u) {
                return u.id == teamUser.id;
            });

            this.$http['delete']('/settings/teams/' + TEAM_ID + '/members/' + teamUser.id).success(function (team) {
                this.$dispatch('teamUpdated', team);
            });
        },
        ...
        leaveTeam: function leaveTeam() {
            ...
            this.$http['delete']('/settings/teams/' + TEAM_ID + '/membership').success(function () {
...
},{"./core/components":82,"./core/dependencies":83}]},{},[91]);
